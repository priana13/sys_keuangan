<div class="px-6 py-6 lg:px-8 md:w-3/4">
    ...
    <form wire:submit="import" class="space-y-6 card bg-white rounded shadow p-5" action="#">
      ...
      <div class="flex">
            ...
            <div class="mx-2">
                <a type="submit" href="{{ route('pemasukan') }}" wire:navigate class="w-full text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Kembali</a>
            </div>
