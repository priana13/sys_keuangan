<div >
    ...
    <div class="mb-3 flex justify-between mt-8">
        ...
        <div class="flex">                
            ...
            <div class="mx-1">
                <a href="{{ route('pengeluaran.import') }}" class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-gray-800 rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-800 dark:focus:ring-gray-900">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td>
                            ...
                            <div class="flex items-center space-x-3.5">
                                ...
                                {{-- href="{{ route('pengeluaran.edit', $row->id) }}"  --}}
    ...
    <script>
        ...
        // // const tampilkanPopupButton = document.getElementById("tampilkanPopup");
        // const tutupPopupButton = document.getElementById("tutupPopup");
        // const popupWrapper = document.getElementById("popupWrapper");

        // tampilkanPopupButton.addEventListener("click", function () {
        // popupWrapper.style.display = "flex";
        // });

        // tutupPopupButton.addEventListener("click", function () {
