<div>
    ...
    <div class="mb-3 flex justify-between mt-8">
        ...
        <div>
             <a href="{{ route('user.tambah') }}" wire:navigate class="px-3 py-2 text-xs font-medium text-center inline-flex items-center text-white bg-gray-800 rounded-lg hover:bg-gray-900 focus:ring-4 focus:outline-none focus:ring-gray-300 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    ...
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td>
                            ...
                            <div class="flex items-center space-x-3.5">
                                ...
                                <button wire:click="delete({{ $user->id }})" wire:key="delete-{{ $user->id }}" class="hover:text-primary">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
